...
const data = {
  navMain: [
    ...
    { title: "New assessment", url: "/admin/assessments/new", icon: IconFileDescription },
  ],
  navGroups: [
    {
      id: "organization",
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Notifications", url: "/admin/user/notifications", icon: IconReport },
          ...
          return (
            <SidebarMenu key={group.id}>
              <SidebarMenuItem>
                ...
                {isOpen && (
                  <SidebarMenuSub id={`${group.id}-submenu`} role="region" aria-label={`${group.title} submenu`}>
